...
public class StudyDashboard {
  ...
  private Participant findFirst(List<GHIssueComment> comments, int eventId)
      throws IOException {
  ...
  private void printFirstParticipants() {
    Arrays.stream(this.firstParticipantsForEachEvent)
  ...
  private Participant findExistingParticipant(String username, List<Participant> participants) {
    ...
    participant = participants.stream().filter(p -> p.username().equals(username)).findFirst()
        .orElseThrow();
    return participant;
  }
